...
(define-constant err-peg-wallet-already-set (err u2002))
...
(define-constant err-unknown-peg-out-request (err u2006))
(define-constant err-peg-out-not-pending (err u2007))
